...
plot(my_fit$pars_track$sigma2_track, type="l")
plot(my_fit$pars_track$tau_track, type="l")
matplot(t(my_fit$pars_track$alpha_track), type="l")
matplot(t(my_fit$pars_track$big_sigma_track)[,1], type="l")
matplot(t(my_fit$pars_track$big_sigma_track)[,2], type="l")
matplot(t(my_fit$pars_track$big_sigma_track)[,4], type="l")
