...
private:
  ...
  arma::mat post_f;             // n_i x num_clusters
  arma::cube post_1f;           // n_i x 2 x num_clusters
  arma::cube post_1f_star;      // n_i x 2 x num_clusters
  arma::mat post_amp_mu;        // num_clusters x 2
  arma::mat tmp_post_amp_sigma; // 2 x 2
