...
```{r example-1-saem, echo=TRUE, cache=FALSE}
...
```{r example-2-saem-unimodal, echo=TRUE, message=FALSE, cache=FALSE}
...
### Unknown base shape
```{r example-2-saem-flexShape, echo=TRUE, message=FALSE, cache=FALSE}
